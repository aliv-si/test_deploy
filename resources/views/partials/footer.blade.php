<footer class="bg-white pb-8">
    <div class="mx-auto px-6 md:px-10">
        <!-- Card Footer with Gradient Mesh -->
            ...
            <div class="relative z-10">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                        ...
                        <div>
                            ...
                            <div class="flex space-x-3 mt-2">
                                <a href="https://www.instagram.com/himasiamikom" target="_blank"
                                    class="text-blue-600 text-xl"><svg xmlns="http://www.w3.org/2000/svg" width="32"
                                ...
                                <a href="https://www.tiktok.com/@himasiamikom?_t=ZS-8wAvgiWLYB8&_r=1" target="_blank"
                                    class="text-blue-600 text-xl"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                    ...
                    <div class="hidden md:block">
                        ...
                        <ul class="text-gray-600 space-y-2 font-poppins">
