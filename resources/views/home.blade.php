...
<body class="bg-white">
    ...
    <nav class="flex justify-between items-center px-6 py-4 shadow-md bg-white relative">
        ...
        <div class="flex items-center space-x-3">
            ...
            <span class="text-lg font-medium text-third-300">HIMASI</span>
        </div>

        <!-- Navigation Links (Desktop) -->
        <ul class="hidden md:flex space-x-6 text-third-300">
            ...
            <li><a href="#" class="relative hover:text-primary-600 font-poppins font-medium group">Profil
                    <span
                        class="absolute left-0 bottom-0 w-0 h-0.5 bg-primary-200 transition-all group-hover:w-full"></span></a>
            </li>
            <li><a href="#" class="relative hover:text-primary-600 font-poppins font-medium group">Departemen
                    <span
                        class="absolute left-0 bottom-0 w-0 h-0.5 bg-primary-200 transition-all group-hover:w-full"></span></a>
            </li>
            <li><a href="#" class="relative hover:text-primary-600 font-poppins font-medium group">Berita
                    <span
                        class="absolute left-0 bottom-0 w-0 h-0.5 bg-primary-200 transition-all group-hover:w-full"></span></a>
            </li>
            <li><a href="#" class="relative hover:text-primary-600 font-poppins font-medium group">Bank Soal
                    <span
                        class="absolute left-0 bottom-0 w-0 h-0.5 bg-primary-200 transition-all group-hover:w-full"></span></a>
            </li>
        </ul>
        ...
        <div id="mobile-menu"
            ...
            <ul class="flex flex-col space-y-3 p-4 text-third-300">
                <li><a href="#" class="block hover:text-blue-600 pb-2">Home</a></li>
                <li><a href="#" class="block hover:text-blue-600 pb-2">Profil</a></li>
                <li><a href="#" class="block hover:text-blue-600 pb-2">Departemen</a></li>
                <li><a href="#" class="block hover:text-blue-600 pb-2">Berita</a></li>
                <li><a href="#" class="block hover:text-blue-600 pb-2">Bank Soal</a></li>
            </ul>
        </div>
    </nav>
    ...
    <main>
        ...
        <header class="relative flex flex-col-reverse md:flex-row items-center justify-between px-6 md:px-20 py-16">
            ...
            <div class="relative md:w-1/2 text-center md:text-left">
                <h1 class="text-3xl md:text-5xl font-bold text-third font-poppins">Himpunan Mahasiswa<br>Program
                    Studi<br>Sistem
                    Informasi</h1>
                <div class="w-3xs h-1.5 bg-primary-200 mt-2"></div>
                <p class="text-third-300 mt-3 text-lg font-playfair">Adaptif, Inovatif, Kreatif</p>
            </div>
        ...
        <section class="bg-white py-16 px-6 md:px-20">
            <div class="flex flex-col items-center pb-4">
                <h2 class="text-3xl font-poppins text-primary-300">Berita Acara</h2>
                    ...
                    <div class="slide">
                        <div class="flex flex-col md:flex-row gap-6">
                            <div class="flex-1">
                                ...
                                <h1 class="text-2xl font-bold text-gray-900 font-poppins">Seminar Publik Speaking</h1>
        ...
        <section class="relative py-16 px-6 md:px-20">
            ...
            <div class="flex flex-col items-center text-center relative z-10 pb-6">
                <h2 class="text-4xl font-bold text-gray-900">Aspirasi</h2>
                ...
                <div class="flex flex-col md:flex-row gap-8 mt-6">
                    ...
                    <div class="md:w-1/2 bg-gray-50 p-6 rounded-xl shadow-md relative border border-gray-300">
                        <form>
                            ...
                            <!-- Input Aspirasi -->
                            <label for="aspirasi" class="block text-gray-700 font-semibold mb-1">
                                Aspirasimu <span class="text-red-500">*</span>
                            </label>
                            <textarea id="aspirasi" rows="4"
                                class="w-full p-2 border border-gray-400 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 mb-4"
                                required></textarea>

                            <!-- Tombol Kirim -->
                            <button type="submit"
                                class="bg-blue-700 text-white font-semibold px-6 py-2 rounded-lg shadow-md w-28 mx-auto block">
                                Kirim
                            </button>
                        </form>
                    </div>
            ...
            <div class="max-w-7xl mx-auto px-6 md:px-10">
                ...
                <div class="bg-gray-100 p-6 rounded-xl shadow-lg">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                        ...
                        <div>
                            <h3 class="font-semibold text-lg">Universitas Amikom Yogyakarta</h3>
                            ...
                            <ul class="text-gray-700 space-y-1">
                                ...
                                <li><a href="#" class="hover:text-blue-600">&gt; Departemen</a></li>
                                <li><a href="#" class="hover:text-blue-600">&gt; Berita</a></li>
                                <li><a href="#" class="hover:text-blue-600">&gt; Bank Soal</a></li>
                            </ul>
                        </div>
